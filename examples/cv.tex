...
\name{Galih}{Wicaksono}
\position{FrontEnd Developer{\enskip\cdotp\enskip}FullStack Developer}
% \address{235, World Cup buk-ro, Mapo-gu, Seoul, 03936, Republic of Korea}

\mobile{(+62) 899-5045-687}
\email{galihwicaksono90@gmail.com}
%\dateofbirth{January 1st, 1970}
% \homepage{www.posquit0.com}
\github{galihwicaksono90}
\linkedin{galih-wicaksono-b51a97208}
% \gitlab{gitlab-id}
...
\makecvfooter
  {\today}
  {Galih Wicaksono~~~·~~~Curriculum Vitae}
  {\thepage}
